...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TYPE "public"."enum_pages_blocks_content_columns_media_aspect_ratio" AS ENUM('square', 'landscape', 'portrait');
  ...
  CREATE TYPE "public"."enum__pages_v_blocks_content_columns_media_aspect_ratio" AS ENUM('square', 'landscape', 'portrait');
  ...
  CREATE TYPE "public"."enum_works_blocks_content_columns_media_aspect_ratio" AS ENUM('square', 'landscape', 'portrait');
  ...
  CREATE TYPE "public"."enum__works_v_blocks_content_columns_media_aspect_ratio" AS ENUM('square', 'landscape', 'portrait');
  ...
  CREATE TABLE IF NOT EXISTS "pages_blocks_content_columns_slider_slides" (
  	"_order" integer NOT NULL,
  	"_parent_id" varchar NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  ...
  CREATE TABLE IF NOT EXISTS "pages_blocks_content_columns" (
  	...
  	"section_heading_heading" varchar,
  	"section_heading_subheading" varchar,
  	...
  	"slider_space_mt" "enum_pages_blocks_content_columns_slider_space_mt" DEFAULT 'md',
  	"slider_space_mb" "enum_pages_blocks_content_columns_slider_space_mb" DEFAULT 'md',
  ...
  CREATE TABLE IF NOT EXISTS "pages_blocks_content" (
  	...
  	"_path" text NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"theme" "enum_pages_blocks_content_theme" DEFAULT 'light',
  	"space_pt" "enum_pages_blocks_content_space_pt" DEFAULT 'md',
  	"space_pb" "enum_pages_blocks_content_space_pb" DEFAULT 'md',
  	"space_mt" "enum_pages_blocks_content_space_mt" DEFAULT 'md',
  	"space_mb" "enum_pages_blocks_content_space_mb" DEFAULT 'md',
  	"block_name" varchar
  );
  ...
  CREATE TABLE IF NOT EXISTS "pages_blocks_slider" (
  	...
  	"space_mt" "enum_pages_blocks_slider_space_mt" DEFAULT 'md',
  	"space_mb" "enum_pages_blocks_slider_space_mb" DEFAULT 'md',
  	"block_name" varchar
  );
  ...
  CREATE TABLE IF NOT EXISTS "_pages_v_blocks_content_columns_slider_slides" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  	"slide_image_id" integer,
  ...
  CREATE TABLE IF NOT EXISTS "_pages_v_blocks_content_columns" (
  	...
  	"slider_space_mt" "enum__pages_v_blocks_content_columns_slider_space_mt" DEFAULT 'md',
  	"slider_space_mb" "enum__pages_v_blocks_content_columns_slider_space_mb" DEFAULT 'md',
  	"media_media_id" integer,
  ...
  CREATE TABLE IF NOT EXISTS "_pages_v_blocks_content" (
  	...
  	"_path" text NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  	"theme" "enum__pages_v_blocks_content_theme" DEFAULT 'light',
  	"space_pt" "enum__pages_v_blocks_content_space_pt" DEFAULT 'md',
  	"space_pb" "enum__pages_v_blocks_content_space_pb" DEFAULT 'md',
  	"space_mt" "enum__pages_v_blocks_content_space_mt" DEFAULT 'md',
  	"space_mb" "enum__pages_v_blocks_content_space_mb" DEFAULT 'md',
  	"_uuid" varchar,
  	"block_name" varchar
  );
  ...
  CREATE TABLE IF NOT EXISTS "_pages_v_blocks_slider_slides" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  	"slide_image_id" integer,
  ...
  CREATE TABLE IF NOT EXISTS "_pages_v_blocks_slider" (
  	...
  	"space_mt" "enum__pages_v_blocks_slider_space_mt" DEFAULT 'md',
  	"space_mb" "enum__pages_v_blocks_slider_space_mb" DEFAULT 'md',
  	"_uuid" varchar,
  	"block_name" varchar
  );
  ...
  CREATE TABLE IF NOT EXISTS "works_hero_links" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  ...
  CREATE TABLE IF NOT EXISTS "works_blocks_cta_links" (
  	"_order" integer NOT NULL,
  	"_parent_id" varchar NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  ...
  CREATE TABLE IF NOT EXISTS "works_blocks_cta" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"_path" text NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  ...
  CREATE TABLE IF NOT EXISTS "works_blocks_content_columns_slider_slides" (
  	"_order" integer NOT NULL,
  	"_parent_id" varchar NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"slide_image_id" integer,
  ...
  CREATE TABLE IF NOT EXISTS "works_blocks_content_columns" (
  	"_order" integer NOT NULL,
  	"_parent_id" varchar NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"size" "enum_works_blocks_content_columns_size" DEFAULT 'oneThird',
  	"content_type" "enum_works_blocks_content_columns_content_type" DEFAULT 'text',
  	"text_rich_text" jsonb,
  	"text_enable_link" boolean,
  	...
  	"slider_space_mt" "enum_works_blocks_content_columns_slider_space_mt" DEFAULT 'md',
  	"slider_space_mb" "enum_works_blocks_content_columns_slider_space_mb" DEFAULT 'md',
  	"media_media_id" integer,
  	"media_aspect_ratio" "enum_works_blocks_content_columns_media_aspect_ratio" DEFAULT 'landscape'
  );
  
  CREATE TABLE IF NOT EXISTS "works_blocks_content" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"_path" text NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"theme" "enum_works_blocks_content_theme" DEFAULT 'light',
  	"space_pt" "enum_works_blocks_content_space_pt" DEFAULT 'md',
  	"space_pb" "enum_works_blocks_content_space_pb" DEFAULT 'md',
  	"space_mt" "enum_works_blocks_content_space_mt" DEFAULT 'md',
  	"space_mb" "enum_works_blocks_content_space_mb" DEFAULT 'md',
  	"block_name" varchar
  );
  
  CREATE TABLE IF NOT EXISTS "works_blocks_media_block" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"_path" text NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  ...
  CREATE TABLE IF NOT EXISTS "works_blocks_archive" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"_path" text NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  ...
  CREATE TABLE IF NOT EXISTS "works_blocks_form_block" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"_path" text NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  ...
  CREATE TABLE IF NOT EXISTS "works_blocks_slider_slides" (
  	"_order" integer NOT NULL,
  	"_parent_id" varchar NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"slide_image_id" integer,
  ...
  CREATE TABLE IF NOT EXISTS "works_blocks_slider" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"_path" text NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	...
  	"space_mt" "enum_works_blocks_slider_space_mt" DEFAULT 'md',
  	"space_mb" "enum_works_blocks_slider_space_mb" DEFAULT 'md',
  	"block_name" varchar
  );
  
  CREATE TABLE IF NOT EXISTS "works_blocks_tabs_tabs_slider_slides" (
  	"_order" integer NOT NULL,
  	"_parent_id" varchar NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"slide_image_id" integer,
  ...
  CREATE TABLE IF NOT EXISTS "works_blocks_tabs_tabs" (
  	"_order" integer NOT NULL,
  	"_parent_id" varchar NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"tab_title" varchar,
  ...
  CREATE TABLE IF NOT EXISTS "works_blocks_tabs" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"_path" text NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	...
  	"space_mt" "enum_works_blocks_tabs_space_mt" DEFAULT 'md',
  	"space_mb" "enum_works_blocks_tabs_space_mb" DEFAULT 'md',
  	"block_name" varchar
  );
  ...
  CREATE TABLE IF NOT EXISTS "_works_v_version_hero_links" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  ...
  CREATE TABLE IF NOT EXISTS "_works_v_blocks_cta_links" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  ...
  CREATE TABLE IF NOT EXISTS "_works_v_blocks_cta" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"_path" text NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  ...
  CREATE TABLE IF NOT EXISTS "_works_v_blocks_content_columns_slider_slides" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  	"slide_image_id" integer,
  ...
  CREATE TABLE IF NOT EXISTS "_works_v_blocks_content_columns" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  	"size" "enum__works_v_blocks_content_columns_size" DEFAULT 'oneThird',
  	"content_type" "enum__works_v_blocks_content_columns_content_type" DEFAULT 'text',
  	"text_rich_text" jsonb,
  	"text_enable_link" boolean,
  	...
  	"slider_space_mt" "enum__works_v_blocks_content_columns_slider_space_mt" DEFAULT 'md',
  	"slider_space_mb" "enum__works_v_blocks_content_columns_slider_space_mb" DEFAULT 'md',
  	"media_media_id" integer,
  	"media_aspect_ratio" "enum__works_v_blocks_content_columns_media_aspect_ratio" DEFAULT 'landscape',
  	"_uuid" varchar
  );
  
  CREATE TABLE IF NOT EXISTS "_works_v_blocks_content" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"_path" text NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  	"theme" "enum__works_v_blocks_content_theme" DEFAULT 'light',
  	"space_pt" "enum__works_v_blocks_content_space_pt" DEFAULT 'md',
  	"space_pb" "enum__works_v_blocks_content_space_pb" DEFAULT 'md',
  	"space_mt" "enum__works_v_blocks_content_space_mt" DEFAULT 'md',
  	"space_mb" "enum__works_v_blocks_content_space_mb" DEFAULT 'md',
  	"_uuid" varchar,
  	"block_name" varchar
  );
  
  CREATE TABLE IF NOT EXISTS "_works_v_blocks_media_block" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"_path" text NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  ...
  CREATE TABLE IF NOT EXISTS "_works_v_blocks_archive" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"_path" text NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  ...
  CREATE TABLE IF NOT EXISTS "_works_v_blocks_form_block" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"_path" text NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  ...
  CREATE TABLE IF NOT EXISTS "_works_v_blocks_slider_slides" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  	"slide_image_id" integer,
  ...
  CREATE TABLE IF NOT EXISTS "_works_v_blocks_slider" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"_path" text NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  	...
  	"space_mt" "enum__works_v_blocks_slider_space_mt" DEFAULT 'md',
  	"space_mb" "enum__works_v_blocks_slider_space_mb" DEFAULT 'md',
  	"_uuid" varchar,
  	"block_name" varchar
  );
  
  CREATE TABLE IF NOT EXISTS "_works_v_blocks_tabs_tabs_slider_slides" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  	"slide_image_id" integer,
  ...
  CREATE TABLE IF NOT EXISTS "_works_v_blocks_tabs_tabs" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  	"tab_title" varchar,
  ...
  CREATE TABLE IF NOT EXISTS "_works_v_blocks_tabs" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"_path" text NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  	...
  	"space_mt" "enum__works_v_blocks_tabs_space_mt" DEFAULT 'md',
  	"space_mb" "enum__works_v_blocks_tabs_space_mb" DEFAULT 'md',
  	"_uuid" varchar,
  	"block_name" varchar
  );
  ...
  CREATE TABLE IF NOT EXISTS "_works_v_rels" (
  	"id" serial PRIMARY KEY NOT NULL,
  	"order" integer,
  	"parent_id" integer NOT NULL,
  	"path" varchar NOT NULL,
  ...
  CREATE INDEX IF NOT EXISTS "pages_blocks_content_columns_slider_slides_order_idx" ON "pages_blocks_content_columns_slider_slides" USING btree ("_order");
  CREATE INDEX IF NOT EXISTS "pages_blocks_content_columns_slider_slides_parent_id_idx" ON "pages_blocks_content_columns_slider_slides" USING btree ("_parent_id");
  CREATE INDEX IF NOT EXISTS "pages_blocks_content_columns_slider_slides_slide_slide_image_idx" ON "pages_blocks_content_columns_slider_slides" USING btree ("slide_image_id");
  ...
  CREATE INDEX IF NOT EXISTS "pages_blocks_content_columns_media_media_media_idx" ON "pages_blocks_content_columns" USING btree ("media_media_id");
  ...
  CREATE INDEX IF NOT EXISTS "pages_blocks_slider_slides_order_idx" ON "pages_blocks_slider_slides" USING btree ("_order");
  CREATE INDEX IF NOT EXISTS "pages_blocks_slider_slides_parent_id_idx" ON "pages_blocks_slider_slides" USING btree ("_parent_id");
  CREATE INDEX IF NOT EXISTS "pages_blocks_slider_slides_slide_slide_image_idx" ON "pages_blocks_slider_slides" USING btree ("slide_image_id");
  ...
  CREATE INDEX IF NOT EXISTS "pages_rels_works_id_idx" ON "pages_rels" USING btree ("works_id");
  ...
  CREATE INDEX IF NOT EXISTS "_pages_v_blocks_content_columns_slider_slides_order_idx" ON "_pages_v_blocks_content_columns_slider_slides" USING btree ("_order");
  CREATE INDEX IF NOT EXISTS "_pages_v_blocks_content_columns_slider_slides_parent_id_idx" ON "_pages_v_blocks_content_columns_slider_slides" USING btree ("_parent_id");
  CREATE INDEX IF NOT EXISTS "_pages_v_blocks_content_columns_slider_slides_slide_slide_image_idx" ON "_pages_v_blocks_content_columns_slider_slides" USING btree ("slide_image_id");
  ...
  CREATE INDEX IF NOT EXISTS "_pages_v_blocks_content_columns_media_media_media_idx" ON "_pages_v_blocks_content_columns" USING btree ("media_media_id");
  ...
  CREATE INDEX IF NOT EXISTS "_pages_v_blocks_slider_slides_order_idx" ON "_pages_v_blocks_slider_slides" USING btree ("_order");
  CREATE INDEX IF NOT EXISTS "_pages_v_blocks_slider_slides_parent_id_idx" ON "_pages_v_blocks_slider_slides" USING btree ("_parent_id");
  CREATE INDEX IF NOT EXISTS "_pages_v_blocks_slider_slides_slide_slide_image_idx" ON "_pages_v_blocks_slider_slides" USING btree ("slide_image_id");
  ...
  CREATE INDEX IF NOT EXISTS "_pages_v_rels_works_id_idx" ON "_pages_v_rels" USING btree ("works_id");
  ...
  CREATE INDEX IF NOT EXISTS "works_hero_links_order_idx" ON "works_hero_links" USING btree ("_order");
  CREATE INDEX IF NOT EXISTS "works_hero_links_parent_id_idx" ON "works_hero_links" USING btree ("_parent_id");
  CREATE INDEX IF NOT EXISTS "works_blocks_cta_links_order_idx" ON "works_blocks_cta_links" USING btree ("_order");
  CREATE INDEX IF NOT EXISTS "works_blocks_cta_links_parent_id_idx" ON "works_blocks_cta_links" USING btree ("_parent_id");
  CREATE INDEX IF NOT EXISTS "works_blocks_cta_order_idx" ON "works_blocks_cta" USING btree ("_order");
  CREATE INDEX IF NOT EXISTS "works_blocks_cta_parent_id_idx" ON "works_blocks_cta" USING btree ("_parent_id");
  CREATE INDEX IF NOT EXISTS "works_blocks_cta_path_idx" ON "works_blocks_cta" USING btree ("_path");
  CREATE INDEX IF NOT EXISTS "works_blocks_content_columns_slider_slides_order_idx" ON "works_blocks_content_columns_slider_slides" USING btree ("_order");
  CREATE INDEX IF NOT EXISTS "works_blocks_content_columns_slider_slides_parent_id_idx" ON "works_blocks_content_columns_slider_slides" USING btree ("_parent_id");
  CREATE INDEX IF NOT EXISTS "works_blocks_content_columns_slider_slides_slide_slide_image_idx" ON "works_blocks_content_columns_slider_slides" USING btree ("slide_image_id");
  CREATE INDEX IF NOT EXISTS "works_blocks_content_columns_order_idx" ON "works_blocks_content_columns" USING btree ("_order");
  CREATE INDEX IF NOT EXISTS "works_blocks_content_columns_parent_id_idx" ON "works_blocks_content_columns" USING btree ("_parent_id");
  CREATE INDEX IF NOT EXISTS "works_blocks_content_columns_media_media_media_idx" ON "works_blocks_content_columns" USING btree ("media_media_id");
  CREATE INDEX IF NOT EXISTS "works_blocks_content_order_idx" ON "works_blocks_content" USING btree ("_order");
  CREATE INDEX IF NOT EXISTS "works_blocks_content_parent_id_idx" ON "works_blocks_content" USING btree ("_parent_id");
  CREATE INDEX IF NOT EXISTS "works_blocks_content_path_idx" ON "works_blocks_content" USING btree ("_path");
  CREATE INDEX IF NOT EXISTS "works_blocks_media_block_order_idx" ON "works_blocks_media_block" USING btree ("_order");
  CREATE INDEX IF NOT EXISTS "works_blocks_media_block_parent_id_idx" ON "works_blocks_media_block" USING btree ("_parent_id");
  CREATE INDEX IF NOT EXISTS "works_blocks_media_block_path_idx" ON "works_blocks_media_block" USING btree ("_path");
  CREATE INDEX IF NOT EXISTS "works_blocks_media_block_media_idx" ON "works_blocks_media_block" USING btree ("media_id");
  CREATE INDEX IF NOT EXISTS "works_blocks_archive_order_idx" ON "works_blocks_archive" USING btree ("_order");
  CREATE INDEX IF NOT EXISTS "works_blocks_archive_parent_id_idx" ON "works_blocks_archive" USING btree ("_parent_id");
  CREATE INDEX IF NOT EXISTS "works_blocks_archive_path_idx" ON "works_blocks_archive" USING btree ("_path");
  CREATE INDEX IF NOT EXISTS "works_blocks_form_block_order_idx" ON "works_blocks_form_block" USING btree ("_order");
  CREATE INDEX IF NOT EXISTS "works_blocks_form_block_parent_id_idx" ON "works_blocks_form_block" USING btree ("_parent_id");
  CREATE INDEX IF NOT EXISTS "works_blocks_form_block_path_idx" ON "works_blocks_form_block" USING btree ("_path");
  CREATE INDEX IF NOT EXISTS "works_blocks_form_block_form_idx" ON "works_blocks_form_block" USING btree ("form_id");
  ...
  CREATE INDEX IF NOT EXISTS "works_blocks_slider_slides_order_idx" ON "works_blocks_slider_slides" USING btree ("_order");
  CREATE INDEX IF NOT EXISTS "works_blocks_slider_slides_parent_id_idx" ON "works_blocks_slider_slides" USING btree ("_parent_id");
  CREATE INDEX IF NOT EXISTS "works_blocks_slider_slides_slide_slide_image_idx" ON "works_blocks_slider_slides" USING btree ("slide_image_id");
  CREATE INDEX IF NOT EXISTS "works_blocks_slider_order_idx" ON "works_blocks_slider" USING btree ("_order");
  CREATE INDEX IF NOT EXISTS "works_blocks_slider_parent_id_idx" ON "works_blocks_slider" USING btree ("_parent_id");
  CREATE INDEX IF NOT EXISTS "works_blocks_slider_path_idx" ON "works_blocks_slider" USING btree ("_path");
  CREATE INDEX IF NOT EXISTS "works_blocks_tabs_tabs_slider_slides_order_idx" ON "works_blocks_tabs_tabs_slider_slides" USING btree ("_order");
  CREATE INDEX IF NOT EXISTS "works_blocks_tabs_tabs_slider_slides_parent_id_idx" ON "works_blocks_tabs_tabs_slider_slides" USING btree ("_parent_id");
  CREATE INDEX IF NOT EXISTS "works_blocks_tabs_tabs_slider_slides_slide_slide_image_idx" ON "works_blocks_tabs_tabs_slider_slides" USING btree ("slide_image_id");
  CREATE INDEX IF NOT EXISTS "works_blocks_tabs_tabs_order_idx" ON "works_blocks_tabs_tabs" USING btree ("_order");
  CREATE INDEX IF NOT EXISTS "works_blocks_tabs_tabs_parent_id_idx" ON "works_blocks_tabs_tabs" USING btree ("_parent_id");
  CREATE INDEX IF NOT EXISTS "works_blocks_tabs_order_idx" ON "works_blocks_tabs" USING btree ("_order");
  CREATE INDEX IF NOT EXISTS "works_blocks_tabs_parent_id_idx" ON "works_blocks_tabs" USING btree ("_parent_id");
  CREATE INDEX IF NOT EXISTS "works_blocks_tabs_path_idx" ON "works_blocks_tabs" USING btree ("_path");
  CREATE INDEX IF NOT EXISTS "works_hero_hero_media_idx" ON "works" USING btree ("hero_media_id");
  CREATE INDEX IF NOT EXISTS "works_meta_meta_image_idx" ON "works" USING btree ("meta_image_id");
  CREATE INDEX IF NOT EXISTS "works_slug_idx" ON "works" USING btree ("slug");
  ...
  CREATE INDEX IF NOT EXISTS "works_rels_pages_id_idx" ON "works_rels" USING btree ("pages_id");
  CREATE INDEX IF NOT EXISTS "works_rels_posts_id_idx" ON "works_rels" USING btree ("posts_id");
  CREATE INDEX IF NOT EXISTS "works_rels_works_id_idx" ON "works_rels" USING btree ("works_id");
  CREATE INDEX IF NOT EXISTS "works_rels_categories_id_idx" ON "works_rels" USING btree ("categories_id");
  CREATE INDEX IF NOT EXISTS "_works_v_version_hero_links_order_idx" ON "_works_v_version_hero_links" USING btree ("_order");
  CREATE INDEX IF NOT EXISTS "_works_v_version_hero_links_parent_id_idx" ON "_works_v_version_hero_links" USING btree ("_parent_id");
  CREATE INDEX IF NOT EXISTS "_works_v_blocks_cta_links_order_idx" ON "_works_v_blocks_cta_links" USING btree ("_order");
  CREATE INDEX IF NOT EXISTS "_works_v_blocks_cta_links_parent_id_idx" ON "_works_v_blocks_cta_links" USING btree ("_parent_id");
  CREATE INDEX IF NOT EXISTS "_works_v_blocks_cta_order_idx" ON "_works_v_blocks_cta" USING btree ("_order");
  CREATE INDEX IF NOT EXISTS "_works_v_blocks_cta_parent_id_idx" ON "_works_v_blocks_cta" USING btree ("_parent_id");
  CREATE INDEX IF NOT EXISTS "_works_v_blocks_cta_path_idx" ON "_works_v_blocks_cta" USING btree ("_path");
  CREATE INDEX IF NOT EXISTS "_works_v_blocks_content_columns_slider_slides_order_idx" ON "_works_v_blocks_content_columns_slider_slides" USING btree ("_order");
  CREATE INDEX IF NOT EXISTS "_works_v_blocks_content_columns_slider_slides_parent_id_idx" ON "_works_v_blocks_content_columns_slider_slides" USING btree ("_parent_id");
  CREATE INDEX IF NOT EXISTS "_works_v_blocks_content_columns_slider_slides_slide_slide_image_idx" ON "_works_v_blocks_content_columns_slider_slides" USING btree ("slide_image_id");
  CREATE INDEX IF NOT EXISTS "_works_v_blocks_content_columns_order_idx" ON "_works_v_blocks_content_columns" USING btree ("_order");
  CREATE INDEX IF NOT EXISTS "_works_v_blocks_content_columns_parent_id_idx" ON "_works_v_blocks_content_columns" USING btree ("_parent_id");
  CREATE INDEX IF NOT EXISTS "_works_v_blocks_content_columns_media_media_media_idx" ON "_works_v_blocks_content_columns" USING btree ("media_media_id");
  CREATE INDEX IF NOT EXISTS "_works_v_blocks_content_order_idx" ON "_works_v_blocks_content" USING btree ("_order");
  CREATE INDEX IF NOT EXISTS "_works_v_blocks_content_parent_id_idx" ON "_works_v_blocks_content" USING btree ("_parent_id");
  CREATE INDEX IF NOT EXISTS "_works_v_blocks_content_path_idx" ON "_works_v_blocks_content" USING btree ("_path");
  CREATE INDEX IF NOT EXISTS "_works_v_blocks_media_block_order_idx" ON "_works_v_blocks_media_block" USING btree ("_order");
  CREATE INDEX IF NOT EXISTS "_works_v_blocks_media_block_parent_id_idx" ON "_works_v_blocks_media_block" USING btree ("_parent_id");
  CREATE INDEX IF NOT EXISTS "_works_v_blocks_media_block_path_idx" ON "_works_v_blocks_media_block" USING btree ("_path");
  CREATE INDEX IF NOT EXISTS "_works_v_blocks_media_block_media_idx" ON "_works_v_blocks_media_block" USING btree ("media_id");
  CREATE INDEX IF NOT EXISTS "_works_v_blocks_archive_order_idx" ON "_works_v_blocks_archive" USING btree ("_order");
  CREATE INDEX IF NOT EXISTS "_works_v_blocks_archive_parent_id_idx" ON "_works_v_blocks_archive" USING btree ("_parent_id");
  CREATE INDEX IF NOT EXISTS "_works_v_blocks_archive_path_idx" ON "_works_v_blocks_archive" USING btree ("_path");
  CREATE INDEX IF NOT EXISTS "_works_v_blocks_form_block_order_idx" ON "_works_v_blocks_form_block" USING btree ("_order");
  CREATE INDEX IF NOT EXISTS "_works_v_blocks_form_block_parent_id_idx" ON "_works_v_blocks_form_block" USING btree ("_parent_id");
  CREATE INDEX IF NOT EXISTS "_works_v_blocks_form_block_path_idx" ON "_works_v_blocks_form_block" USING btree ("_path");
  CREATE INDEX IF NOT EXISTS "_works_v_blocks_form_block_form_idx" ON "_works_v_blocks_form_block" USING btree ("form_id");
  ...
  CREATE INDEX IF NOT EXISTS "_works_v_blocks_slider_slides_order_idx" ON "_works_v_blocks_slider_slides" USING btree ("_order");
  CREATE INDEX IF NOT EXISTS "_works_v_blocks_slider_slides_parent_id_idx" ON "_works_v_blocks_slider_slides" USING btree ("_parent_id");
  CREATE INDEX IF NOT EXISTS "_works_v_blocks_slider_slides_slide_slide_image_idx" ON "_works_v_blocks_slider_slides" USING btree ("slide_image_id");
  CREATE INDEX IF NOT EXISTS "_works_v_blocks_slider_order_idx" ON "_works_v_blocks_slider" USING btree ("_order");
  CREATE INDEX IF NOT EXISTS "_works_v_blocks_slider_parent_id_idx" ON "_works_v_blocks_slider" USING btree ("_parent_id");
  CREATE INDEX IF NOT EXISTS "_works_v_blocks_slider_path_idx" ON "_works_v_blocks_slider" USING btree ("_path");
  CREATE INDEX IF NOT EXISTS "_works_v_blocks_tabs_tabs_slider_slides_order_idx" ON "_works_v_blocks_tabs_tabs_slider_slides" USING btree ("_order");
  CREATE INDEX IF NOT EXISTS "_works_v_blocks_tabs_tabs_slider_slides_parent_id_idx" ON "_works_v_blocks_tabs_tabs_slider_slides" USING btree ("_parent_id");
  CREATE INDEX IF NOT EXISTS "_works_v_blocks_tabs_tabs_slider_slides_slide_slide_image_idx" ON "_works_v_blocks_tabs_tabs_slider_slides" USING btree ("slide_image_id");
  CREATE INDEX IF NOT EXISTS "_works_v_blocks_tabs_tabs_order_idx" ON "_works_v_blocks_tabs_tabs" USING btree ("_order");
  CREATE INDEX IF NOT EXISTS "_works_v_blocks_tabs_tabs_parent_id_idx" ON "_works_v_blocks_tabs_tabs" USING btree ("_parent_id");
  CREATE INDEX IF NOT EXISTS "_works_v_blocks_tabs_order_idx" ON "_works_v_blocks_tabs" USING btree ("_order");
  CREATE INDEX IF NOT EXISTS "_works_v_blocks_tabs_parent_id_idx" ON "_works_v_blocks_tabs" USING btree ("_parent_id");
  CREATE INDEX IF NOT EXISTS "_works_v_blocks_tabs_path_idx" ON "_works_v_blocks_tabs" USING btree ("_path");
  CREATE INDEX IF NOT EXISTS "_works_v_parent_idx" ON "_works_v" USING btree ("parent_id");
  CREATE INDEX IF NOT EXISTS "_works_v_version_hero_version_hero_media_idx" ON "_works_v" USING btree ("version_hero_media_id");
  CREATE INDEX IF NOT EXISTS "_works_v_version_meta_version_meta_image_idx" ON "_works_v" USING btree ("version_meta_image_id");
  CREATE INDEX IF NOT EXISTS "_works_v_version_version_slug_idx" ON "_works_v" USING btree ("version_slug");
  ...
  CREATE INDEX IF NOT EXISTS "_works_v_autosave_idx" ON "_works_v" USING btree ("autosave");
  CREATE INDEX IF NOT EXISTS "_works_v_rels_order_idx" ON "_works_v_rels" USING btree ("order");
  CREATE INDEX IF NOT EXISTS "_works_v_rels_parent_idx" ON "_works_v_rels" USING btree ("parent_id");
  CREATE INDEX IF NOT EXISTS "_works_v_rels_path_idx" ON "_works_v_rels" USING btree ("path");
  CREATE INDEX IF NOT EXISTS "_works_v_rels_pages_id_idx" ON "_works_v_rels" USING btree ("pages_id");
  CREATE INDEX IF NOT EXISTS "_works_v_rels_posts_id_idx" ON "_works_v_rels" USING btree ("posts_id");
  CREATE INDEX IF NOT EXISTS "_works_v_rels_works_id_idx" ON "_works_v_rels" USING btree ("works_id");
  CREATE INDEX IF NOT EXISTS "_works_v_rels_categories_id_idx" ON "_works_v_rels" USING btree ("categories_id");
  ...
  CREATE INDEX IF NOT EXISTS "payload_locked_documents_rels_works_id_idx" ON "payload_locked_documents_rels" USING btree ("works_id");
