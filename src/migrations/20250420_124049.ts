...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TABLE "pages_blocks_works" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"_path" text NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  ...
  CREATE TABLE "_pages_v_blocks_works" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"_path" text NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  ...
  CREATE TABLE "works_blocks_works" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"_path" text NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  ...
  CREATE TABLE "_works_v_blocks_works" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"_path" text NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  ...
  CREATE INDEX "pages_blocks_works_order_idx" ON "pages_blocks_works" USING btree ("_order");
  CREATE INDEX "pages_blocks_works_parent_id_idx" ON "pages_blocks_works" USING btree ("_parent_id");
  CREATE INDEX "pages_blocks_works_path_idx" ON "pages_blocks_works" USING btree ("_path");
  ...
  CREATE INDEX "_pages_v_blocks_works_order_idx" ON "_pages_v_blocks_works" USING btree ("_order");
  CREATE INDEX "_pages_v_blocks_works_parent_id_idx" ON "_pages_v_blocks_works" USING btree ("_parent_id");
  CREATE INDEX "_pages_v_blocks_works_path_idx" ON "_pages_v_blocks_works" USING btree ("_path");
  ...
  CREATE INDEX "works_blocks_works_order_idx" ON "works_blocks_works" USING btree ("_order");
  CREATE INDEX "works_blocks_works_parent_id_idx" ON "works_blocks_works" USING btree ("_parent_id");
  CREATE INDEX "works_blocks_works_path_idx" ON "works_blocks_works" USING btree ("_path");
  ...
  CREATE INDEX "_works_v_blocks_works_order_idx" ON "_works_v_blocks_works" USING btree ("_order");
  CREATE INDEX "_works_v_blocks_works_parent_id_idx" ON "_works_v_blocks_works" USING btree ("_parent_id");
  CREATE INDEX "_works_v_blocks_works_path_idx" ON "_works_v_blocks_works" USING btree ("_path");
