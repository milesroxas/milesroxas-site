...
export default function BottomSection() {
  ...
  return (
    <div className="container flex w-full items-center justify-between align-middle">
      <div className="text-left font-mono text-slate-700 text-xs uppercase md:text-sm">
        {currentTime}
      </div>
      ...
      <Link href="/contact" className="pointer-events-auto z-50">
        <div className="text-right font-mono text-slate-700 text-xs uppercase tracking-wider">
          Contact
        </div>
      </Link>
    </div>
